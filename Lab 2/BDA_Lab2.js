...
db.Employee.insert({_id:1, EmpName:"Ram",EID: 001, Department:"Sales", Age: 50})
...
db.Employee.update({_id:1,EmpName:"Ram"},{$set:{Hobbies:"Basketball"}},{$upsert:true})
db.Employee.update({_id:2,EmpName:"Sam"},{$set:{Hobbies:"Badminton"}},{$upsert:true})
db.Employee.find()

db.Employee.update({_id:1,EmpName:"Ram"},{$unset:{Hobbies:"Basketball"}},{$upsert:true})
db.Employee.find()

db.Employee.find({})
db.Department.find({})

db.Department.find({DeptID: {$gt:1000, $lt:1005}},{Name:true, DeptID:true})
